...
export default function LightPillar({
  ...
  useEffect(() => {
    if (materialRef.current) materialRef.current.uniforms.uTopColor.value = parseColor(topColor);
  }, [topColor]);

  useEffect(() => {
    if (materialRef.current) materialRef.current.uniforms.uBottomColor.value = parseColor(bottomColor);
  }, [bottomColor]);
